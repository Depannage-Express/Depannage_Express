...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        with transaction.atomic():
            ...
            r8 = Intervention.objects.all().delete()
            r9 = DriverOTP.objects.all().delete()
            r10 = BreakdownRequest.objects.all().delete()
            r11 = MechanicProfile.objects.all().delete()
            r12 = User.objects.exclude(role='admin').delete()
            ...
            self.stdout.write(
                self.style.SUCCESS(
                    ...
                    f'  Interventions supprimées    : {r8[0]}\n'
                    f'  OTPs supprimés              : {r9[0]}\n'
                    f'  Demandes supprimées         : {r10[0]}\n'
                    f'  Mécaniciens supprimés       : {r11[0]}\n'
                    f'  Users supprimés             : {r12[0]}\n'
                    f'  Admins conservés ✅'
                )
            )
