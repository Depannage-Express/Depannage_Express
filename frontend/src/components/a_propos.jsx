  ...
  return (
    <div className="min-h-screen bg-gray-200 relative font-sans">
        ...
        <div className="flex justify-center items-center bg-[#0D2B0D] p-8 border-b border-gray-200">
          <h2 className="text-3xl font-black text-white uppercase tracking-tighter italic">À PROPOS DE DEPANNAGE EXPRESS</h2>
        </div>
        ...
        <div className="bg-white p-8 lg:p-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white p-8 rounded-[2.5rem] shadow-[0_10px_40px_rgba(0,0,0,0.05)] border border-gray-50 space-y-8">
                {/* Mission */}
                <div className="relative">
                  <div className="flex justify-between items-start">
                    <div className="space-y-2 max-w-[70%]">
                      <h4 className="font-black text-sm uppercase">NOTRE MISSION</h4>
...
Devenir la plateforme de référence pour la mobilité urbaine, capable d'éliminer le stress des pannes imprévues en optimisant la rapidité d'intervention et en instaurant un environnement de confiance entre professionnels et usagers.                  </p>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4 pt-10">
                <span className="text-[10px] font-bold text-gray-500 uppercase tracking-tighter">À Propos:</span>
