  ...
  return (
    <section className="bg-[#608C27] border-t-4 border-[#608C27]">
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-2/3 xl:w-3/4 bg-[#608C27] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 justify-items-center gap-4 py-6 lg:py-8 xl:py-10 px-3 md:px-4 max-h-[500px] xl:max-h-[600px] overflow-y-auto [&>div]:max-w-none md:[&>div]:max-w-[256px] lg:[&>div]:max-w-[280px]">
          {isLoading ? (
